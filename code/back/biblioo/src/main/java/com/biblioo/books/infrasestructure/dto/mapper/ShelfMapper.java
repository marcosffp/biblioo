 ...
 *
 * coverPreview e itemCount não existem na entidade — são derivados dos itens
 * da estante enriquecidos com dados dos livros. Por isso recebem esses valores
 * já computados como parâmetros separados, mantendo o mapper stateless e testável.
 *
 * Convenção de chamada:
 *   mapper.toResponse(shelf, itemCount, coverPreview)
