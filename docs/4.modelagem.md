...
|Leitor|Cadastrar-se na plataforma com nome de usuário único e senha|Criar uma conta pessoal segura|
...
|Leitor|Criar coleção de leitura na estante|Organizar livros em grupos|
...
| **Módulo Feed** | Agrega e entrega eventos de atividade dos leitores seguidos, respeitando configurações de privacidade. |
| **Módulo Recommendation** | Gera trilhas de recomendação personalizadas com base no histórico de leitura e afinidade por gênero/autor. |
| **Módulo Identity (DNA Literário)** | Compila o perfil analítico do leitor a partir do histórico consolidado, calculando afinidades e métricas literárias. |
