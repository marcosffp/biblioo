...
|---|---|---|---|---|---|---|
| concurrency | 100 | 7.700 | 468.319 | **101 ms** | 0 | PASSOU |
| load | 160 | 7.400 | 74.888 | **128 ms** | 0 | PASSOU |
...
| Book | shelfItem | 600 | 331,39/s | 717,87 ms | 2.000 ms | PASSOU |
| User | user | 600 | 833,75/s | 349,76 ms | 8.000 ms | PASSOU |
| User | social (grafo) | 250 | 434,53/s | 174,01 ms | 8.000 ms | PASSOU |
...
| Feed | review | 600 | ~109/s | 928,98 ms | 5.000 ms | PASSOU |
...
| Trending | trending | 600 | ~300/s | ~23,8 ms | 8.000 ms | PASSOU |
