...
| RNF-09 | Grafo social (seguidores) | 8 000 ms | social-stress · **174,01 ms** · 250 VUs | social-load · 27,34 ms | [social-stress.png](../code/back/performance-tests/evidencias/stress/DomainUser-social-stress.png) | PASSOU |
...
_O RNF-03 exige que o aplicativo mobile ofereça layout responsivo para telas de 390px a 430px de largura lógica (dp). A evidência foi coletada no emulador **Pixel 8 (2)** com Android 14.0 ("UpsideDownCake"), API level 34, resolução física 1080 × 2400 px e resolução lógica **412 × 915 dp** (densidade 420 dpi). A largura de 412 dp está dentro da faixa exigida. O painel Device Info do Android Studio confirma os parâmetros do dispositivo e a tela "Comunidades" exibe todos os elementos de UI — barra de busca, lista de comunidades com ícone, nome, visibilidade e membros, barra de navegação inferior com 5 abas e FAB do assistente — sem truncamentos, sobreposições, rolagem horizontal indesejada ou quebras de layout._
...
#### RNF-04 — Compatibilidade com Android 14+

_O RNF-04 exige que o sistema seja compatível com dispositivos móveis que executem Android 14+ e iOS 26.5+. Para Android, o aplicativo foi validado no emulador **Pixel 8 (2)** com Android 14.0 ("UpsideDownCake"), API level 34, arquitetura arm64-v8a. O painel Device Info do Android Studio confirma modelo, versão do sistema operacional e nível de API. A tela "Comunidades" carrega, navega e interage corretamente, comprovando que todas as APIs do Flutter utilizadas pelo app são compatíveis com Android 14 (API 34)._

<img src="imagens/comprovacoes/tela_comunidades_android14.png" width="700">

| RNF | Descrição | Resultado |
|---|---|---|
| RNF-04 | Aplicativo mobile compatível com Android 14+ | PASSOU |

---

#### RNF-04 — Compatibilidade com iOS 26.5+

_Para iOS, o aplicativo foi validado em simulador iPhone 17 com iOS 26.5, satisfazendo a segunda exigência do RNF-04 ("O sistema deve ser compatível com dispositivos móveis que executem Android 14+ e iOS 26.5+")._
