...
| RNF-17 | Trending (livros e comunidades) | 8 000 ms | trending-stress · **~22,8 ms** · 600 VUs | trending-load · 31,3 ms | [trending-stress.png](../code/back/performance-tests/evidencias/stress/DomainTrending-trending-stress.png) | PASSOU |
...
| Book | collection | 600 | 585,3/s | 250,07 ms | PASSOU |
| Book | shelf | 600 | 594,4/s | 120,61 ms | PASSOU |
| Book | shelfItem | 600 | 377,6/s | 717,87 ms | PASSOU |
...
| Trending | trending | 600 | ~300/s | ~22,8 ms | PASSOU |
...
| Book | shelfItem | 210 | 409,5/s | 43,89 ms | PASSOU |
| User | user | 210 | 381,31/s | 56,7 ms | PASSOU |
...
| Community | community | 90 | 192,7/s | 15,88 ms | PASSOU |
| Community | invites | 210 | 473,8/s | 28,04 ms | PASSOU |
| Community | join-requests | 210 | ~412/s | 107,08 ms | PASSOU |
| Community | messageRest | 120 | 191,7/s | 94,45 ms | PASSOU |
| Community | message (WS) | 160 | 7.400 env / 74.988 recv | 49,3 ms REST / 128 ms WS | PASSOU |
...
**Estantes — `shelf-stress` (600 VUs · p95 120,61 ms · 594 req/s)**

<img src="../code/back/performance-tests/evidencias/stress/DomainBook-shelf-stress.png" width="700">

**Itens de estante — `shelfItem-stress` (RNF-10 · 600 VUs · p95 717,87 ms · 377 req/s)**
...
**Trending (livros e comunidades em alta) — `trending-stress` (RNF-17 · 600 VUs · p95 ~22,8 ms · ~300 req/s)**
